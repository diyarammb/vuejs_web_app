      ...
      services_data: [
        {
          ...
          subtitle: 'Transforming Ideas into Powerful Custom Software Solutions with eTechFlow.!'
        },
        {
          ...
          title: 'Branding',
          subtitle: 'Elevate Your Brand Image and Captivate Your Audience with eTechFlow`s Branding and Graphics Services!'
        },
        {
          ...
          subtitle: 'Amplify Your Online Presence and Drive Results with eTechFlow`s Digital Marketing Services!'
        },
        {
          ...
          subtitle: 'TCrafting Exceptional Web Experiences with eTechFlow: Empowering Your Online Presence.!'
        },
      ]
    }
  }
